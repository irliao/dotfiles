...
;; Fix GUI app unable to open Terminal error on startup
...
before layers configuration."
  ...
  ;; any variable that layer config code will READ and ACT ON
  (setq-default dotspacemacs-line-numbers 'relative)
  (setq system-uses-terminfo nil)
  ;; attempt to reduce long startup time
...
layers configuration."
  ...
  ;; any variable that Spacemacs explicitly sets but user wishes to override
  ;; No tabs
