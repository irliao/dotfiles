(*
    ...
    Open this file with ScriptEditor and export it as an Application inside /Applications dir, then hold Command and drag it to Finder toolbar.
 *)

-- TODO: automate the installation
