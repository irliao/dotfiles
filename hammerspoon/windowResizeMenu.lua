...
if module.menubar then
  ...
  module.menubar:setMenu(
  {
    ...
    { title = "Full", image = hs.image.imageFromPath("assets/win_full.png"), fn = function() resizeFocusedWindowTo("full") end },
    { title = "Center", image = hs.image.imageFromPath("assets/win_middle.png"), fn = function() resizeFocusedWindowTo("center") end }, -- TODO: replace with correct img
  })
end
