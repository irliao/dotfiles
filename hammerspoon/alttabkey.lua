-- origin: https://github.com/selectnull/hammerspoon-alttab
...
function mod.registerDefaultBindings (key)
    hs.hotkey.bind({"alt"}, key, mod.focusNext)
    hs.hotkey.bind({"alt", "shift"}, key, mod.toggleWindow)
    -- hs.hotkey.bind({"alt", "shift", "shift"}, key, mod.debug)
end

mod.registerDefaultBindings("Tab")
