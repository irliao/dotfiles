...
hs.hotkey.bind(super, 'Z', focusPreviousWindow)
hs.hotkey.bind(super, 'SPACE', hs.hints.windowHints) -- TODO: map Tab to split screen in binary
-- hs.hotkey.bind(super, 'RETURN', centerScreen)
...
hs.hotkey.bind(super, "W", function() openApplication("Electronic WeChat") end)
hs.hotkey.bind(super, "X", function() openApplication("iTerm") end)
hs.hotkey.bind(hyper, "X", function() openApplication("Terminal") end)
